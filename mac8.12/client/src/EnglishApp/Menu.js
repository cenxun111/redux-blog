...
const Menu = () => {
  ...
  return (
    <div className="grid grid-flow-col grid-cols-3  p-4 mt-32 text-4xl text-center bg-gray-100 rounded-3xl">
      ...
      <div className=" pt-4">
        <h1 className=" py-3 px-6 text-white rounded-lg bg-green-400 shadow-lg  "><Link to ={`${url}/allwords`}>收藏</Link></h1>
      </div>
      <div className=" pt-4">
        <h1 className=" py-3 px-6 text-white rounded-lg bg-green-400 shadow-lg"><Link to ={`${url}/chilling`}>阅读</Link></h1>
      </div>
      <div className=" pt-4">
        <h1 className=" py-3 px-6 text-white rounded-lg bg-green-400 shadow-lg"><Link to ={`${url}/jiyi`}>记忆</Link></h1>
      </div>
      </div>
